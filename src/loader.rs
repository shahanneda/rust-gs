    ...
    fn read_body(bytes: &Bytes, header: ReadHeaderResult) -> Vec<PlySplat> {
        ...
        for _i in 0..header.num_splats {
            ...
            splats.push(PlySplat {
                ...
                // Normal vectors
                nx: *vals.get("nx").unwrap_or(&0.0),
                ny: *vals.get("ny").unwrap_or(&0.0),
                nz: *vals.get("nz").unwrap_or(&0.0),
                ...
                f_rest_0: *vals.get("f_rest_0").unwrap_or(&0.0),
                f_rest_1: *vals.get("f_rest_1").unwrap_or(&0.0),
                f_rest_2: *vals.get("f_rest_2").unwrap_or(&0.0),
                f_rest_3: *vals.get("f_rest_3").unwrap_or(&0.0),
                f_rest_4: *vals.get("f_rest_4").unwrap_or(&0.0),
                f_rest_5: *vals.get("f_rest_5").unwrap_or(&0.0),
                f_rest_6: *vals.get("f_rest_6").unwrap_or(&0.0),
                f_rest_7: *vals.get("f_rest_7").unwrap_or(&0.0),
                f_rest_8: *vals.get("f_rest_8").unwrap_or(&0.0),
                f_rest_9: *vals.get("f_rest_9").unwrap_or(&0.0),
                f_rest_10: *vals.get("f_rest_10").unwrap_or(&0.0),
                f_rest_11: *vals.get("f_rest_11").unwrap_or(&0.0),
                f_rest_12: *vals.get("f_rest_12").unwrap_or(&0.0),
                f_rest_13: *vals.get("f_rest_13").unwrap_or(&0.0),
                f_rest_14: *vals.get("f_rest_14").unwrap_or(&0.0),
                f_rest_15: *vals.get("f_rest_15").unwrap_or(&0.0),
                f_rest_16: *vals.get("f_rest_16").unwrap_or(&0.0),
                f_rest_17: *vals.get("f_rest_17").unwrap_or(&0.0),
                f_rest_18: *vals.get("f_rest_18").unwrap_or(&0.0),
                f_rest_19: *vals.get("f_rest_19").unwrap_or(&0.0),
                f_rest_20: *vals.get("f_rest_20").unwrap_or(&0.0),
                f_rest_21: *vals.get("f_rest_21").unwrap_or(&0.0),
                f_rest_22: *vals.get("f_rest_22").unwrap_or(&0.0),
                f_rest_23: *vals.get("f_rest_23").unwrap_or(&0.0),
                f_rest_24: *vals.get("f_rest_24").unwrap_or(&0.0),
                f_rest_25: *vals.get("f_rest_25").unwrap_or(&0.0),
                f_rest_26: *vals.get("f_rest_26").unwrap_or(&0.0),
                f_rest_27: *vals.get("f_rest_27").unwrap_or(&0.0),
                f_rest_28: *vals.get("f_rest_28").unwrap_or(&0.0),
                f_rest_29: *vals.get("f_rest_29").unwrap_or(&0.0),
                f_rest_30: *vals.get("f_rest_30").unwrap_or(&0.0),
                f_rest_31: *vals.get("f_rest_31").unwrap_or(&0.0),
                f_rest_32: *vals.get("f_rest_32").unwrap_or(&0.0),
                f_rest_33: *vals.get("f_rest_33").unwrap_or(&0.0),
                f_rest_34: *vals.get("f_rest_34").unwrap_or(&0.0),
                f_rest_35: *vals.get("f_rest_35").unwrap_or(&0.0),
                f_rest_36: *vals.get("f_rest_36").unwrap_or(&0.0),
                f_rest_37: *vals.get("f_rest_37").unwrap_or(&0.0),
                f_rest_38: *vals.get("f_rest_38").unwrap_or(&0.0),
                f_rest_39: *vals.get("f_rest_39").unwrap_or(&0.0),
                f_rest_40: *vals.get("f_rest_40").unwrap_or(&0.0),
                f_rest_41: *vals.get("f_rest_41").unwrap_or(&0.0),
                f_rest_42: *vals.get("f_rest_42").unwrap_or(&0.0),
                f_rest_43: *vals.get("f_rest_43").unwrap_or(&0.0),
                f_rest_44: *vals.get("f_rest_44").unwrap_or(&0.0),
