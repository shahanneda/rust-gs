...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfd151172077412d1: (a: number, b: number) => void;
export const closure380_externref_shim: (a: number, b: number, c: any) => void;
export const closure382_externref_shim: (a: number, b: number, c: any) => void;
export const closure423_externref_shim: (a: number, b: number, c: any, d: any) => void;
