...
export const closure337_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure344_externref_shim: (a: number, b: number, c: any) => void;
export const closure378_externref_shim: (a: number, b: number, c: any, d: any) => void;
